...
[![CodeChef](https://img.shields.io/badge/CodeChef-5B4638?style=for-the-badge&logo=codechef&logoColor=white)](https://www.codechef.com/users/kit23bam013)
...
Undergraduate Computer Science student at **Kalaignar Karunanidhi Institute of Technology, Coimbatore** with a focus on building production-grade full-stack applications and competitive programming.

- **4-Star** on CodeChef (Max Rating: **1887**) | 82+ rated contests
- **Knight** on LeetCode | Active on **Codeforces**
- Building end-to-end applications with **Spring Boot**, **React Native**, and **PostgreSQL**
- Interested in **Systems Design**, **AI/ML**, and **Cloud Deployment**
...
### [SplitUp — Multi-User Expense Manager](https://github.com/DhaanishNihaal/SplitUp-Multiuser_Expense_Manager)

> Full-stack group expense splitting app with real-time chat — **Splitwise meets WhatsApp**.

| | |
|---|---|
| **Backend** | Spring Boot 3.1, Spring Security (JWT), Spring Data JPA, WebSocket (STOMP + SockJS) |
| **Frontend** | React Native 0.81, Expo SDK 54, TypeScript, Expo Router |
| **Database** | PostgreSQL (Neon serverless) |
| **Deployment** | Render (Docker), Vercel (Web), Expo EAS (APK), UptimeRobot (monitoring) |

**Key Features:**
- Group expense tracking with automatic split calculation
- Greedy settlement engine that minimises the number of payments to settle up
- Real-time chat with typing indicators, online presence, and unread badges
- Group invite system with accept/reject flow
- Role-based access control (User, Moderator, Admin)
- Quick-pay settlement recording with net balance dashboard

[![View Repository](https://img.shields.io/badge/View_Repository-181717?style=flat-square&logo=github&logoColor=white)](https://github.com/DhaanishNihaal/SplitUp-Multiuser_Expense_Manager)
[![Download APK](https://img.shields.io/badge/Download_APK-000020?style=flat-square&logo=expo&logoColor=white)](https://expo.dev/accounts/dhaanishnihaal/projects/expense-manager-mobile/builds/5894077d-858b-4cef-80b1-c47aec7b493f)
...
| Platform | Handle | Rating / Rank | Contests |
|----------|--------|---------------|----------|
| **CodeChef** | [kit23bam013](https://www.codechef.com/users/kit23bam013) | 4-Star (Max: **1887**) | 82+ |
| **LeetCode** | [nihaal11nihaal](https://leetcode.com/u/nihaal11nihaal/) | Knight | — |
| **Codeforces** | [dhaanishnihaal_](https://codeforces.com/profile/dhaanishnihaal_) | — | — |
...
<img src="https://github-readme-stats.vercel.app/api?username=DhaanishNihaal&show_icons=true&theme=github_dark&hide_border=true&count_private=true" alt="GitHub Stats" height="170" />
<img src="https://github-readme-stats.vercel.app/api/top-langs/?username=DhaanishNihaal&layout=compact&theme=github_dark&hide_border=true&langs_count=8" alt="Top Languages" height="170" />
...
**Open to SDE roles and internships. Let's connect.**

[![Email](https://img.shields.io/badge/dhaanishnihaal@gmail.com-D14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:dhaanishnihaal@gmail.com)
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/dhaanish-nihaal-608419292/)
